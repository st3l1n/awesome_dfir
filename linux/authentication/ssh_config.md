...
Можно попробовать восстановить исходящие подключения брутфорсом, перед этим рекомендуется изменить маску на таргетированную под кейс.
`https://github.com/chris408/known_hosts-hashcat`

Системы хэшируются в том виде, в каком были указаны при подключении к ним, то есть помимо IPv4 адреса может быть IPv4 с нестандартным портом, IPv6 или доменное имя.
