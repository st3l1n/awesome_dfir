...
**Awesome DFIR** — практический справочник для специалистов по цифровой криминалистике и реагированию на инциденты. Охватывает методы сбора артефактов, команды анализа и инструменты для основных операционных систем.
...
- **Парсинг** — команды и скрипты для сбора и анализа
...
### Быстрая сортировка (Triage)

В каждом документе есть **Приложение 2 — Quick IR Script** с готовыми командами для быстрого сбора ключевых артефактов. Начните с него при реагировании на инцидент.
...
В **Приложении 1** каждого документа описан порядок летучести артефактов согласно RFC 3227. Следуйте ему при сборе данных с живой системы.
